...
public class ModelZaklnGritch extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		RightFootRightToe.renderWithRotation(f5);
		RightFootLeftToe.renderWithRotation(f5);
		LeftFootLeftToe.renderWithRotation(f5);
		LeftFootRightToe.renderWithRotation(f5);
		RightHoof.renderWithRotation(f5);
		LeftHoof.renderWithRotation(f5);
		RightBottomLeg.renderWithRotation(f5);
		RightMiddleLeg.renderWithRotation(f5);
		LeftBottomLeg.renderWithRotation(f5);
		LeftMiddleLeg.renderWithRotation(f5);
		RightTopLeg.renderWithRotation(f5);
		LeftTopLeg.renderWithRotation(f5);
		BottomBody.renderWithRotation(f5);
		MiddleBody.renderWithRotation(f5);
		TopBody.renderWithRotation(f5);
		RightPec.renderWithRotation(f5);
		LeftPec.renderWithRotation(f5);
		LeftShoulder.renderWithRotation(f5);
		RightShoulder.renderWithRotation(f5);
		LeftTopArm.renderWithRotation(f5);
		RightBottomArm.renderWithRotation(f5);
		RightFrontFinger.renderWithRotation(f5);
		RightBackFinger.renderWithRotation(f5);
		RightThumb.renderWithRotation(f5);
		RightMiddleFinger.renderWithRotation(f5);
		RightHand.renderWithRotation(f5);
		RightTopArm.renderWithRotation(f5);
		LeftBottomArm.renderWithRotation(f5);
		LeftHand.renderWithRotation(f5);
		LeftThumb.renderWithRotation(f5);
		LeftFrontFinger.renderWithRotation(f5);
		LeftMiddleFinger.renderWithRotation(f5);
		LeftBackFinger.renderWithRotation(f5);
		...
		TailHairTip.renderWithRotation(f5);
		TailHair.renderWithRotation(f5);
		Neck1.renderWithRotation(f5);
		Neck2.renderWithRotation(f5);
		Neck3.renderWithRotation(f5);
		Neck4.renderWithRotation(f5);
		Head.renderWithRotation(f5);
		LeftTopLip.renderWithRotation(f5);
		RightTopLip.renderWithRotation(f5);
		MiddleTopLip.renderWithRotation(f5);
		LeftTopJaw.renderWithRotation(f5);
		RightTopJaw.renderWithRotation(f5);
		BottomMouth.renderWithRotation(f5);
		BackMouth.renderWithRotation(f5);
		RightBottomLip.renderWithRotation(f5);
		LeftBottomLip.renderWithRotation(f5);
		FrontBottomLip.renderWithRotation(f5);
		RightMiddleLip.renderWithRotation(f5);
		RightConnectingLip.renderWithRotation(f5);
		LeftMiddleLip.renderWithRotation(f5);
		LeftConnectingLip.renderWithRotation(f5);
		RightTopTooth.renderWithRotation(f5);
		LeftTopTooth.renderWithRotation(f5);
		Tongue1.renderWithRotation(f5);
		Tongue2.renderWithRotation(f5);
		Tongue3.renderWithRotation(f5);
		Tongue4.renderWithRotation(f5);
		RightBottomTooth.renderWithRotation(f5);
		LeftBottomTooth.renderWithRotation(f5);
		RightBottomEar.renderWithRotation(f5);
		RightTopEar.renderWithRotation(f5);
		LeftBottomEar.renderWithRotation(f5);
		LeftTopEar.renderWithRotation(f5);
		...
		RightNose.renderWithRotation(f5);
		LeftNose.renderWithRotation(f5);
		LeftMiddleJaw1.renderWithRotation(f5);
		LeftMiddleJaw2.renderWithRotation(f5);
		LeftMiddleJaw3.renderWithRotation(f5);
		RightMiddleJaw1.renderWithRotation(f5);
		RightMiddleJaw2.renderWithRotation(f5);
		RightMiddleJaw3.renderWithRotation(f5);
	}
